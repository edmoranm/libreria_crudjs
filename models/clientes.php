...
class Cliente extends Conexion
{
    ...
    public function guardar(){
        $sql = "INSERT INTO Clientes(cli_nombre, cli_apellido, cli_direccion, cli_telefono, cli_email) VALUES ('$this->cli_nombre', '$this->cli_apellido', '$this->cli_direccion', '$this->cli_telefono', '$this->cli_email')";
    ...
    public function modificar(){
        $sql = "UPDATE Clientes SET cli_nombre = '$this->cli_nombre', cli_apellido = '$this->cli_apellido', cli_direccion = '$this->cli_direccion', cli_telefono = '$this->cli_telefono', cli_email = '$this->cli_email' WHERE cli_id = $this->cli_id ";
        $resultado = $this->ejecutar($sql);
        return $resultado;
    }    
